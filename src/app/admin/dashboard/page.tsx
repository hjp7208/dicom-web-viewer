...
export default function DashboardPage() {
    ...
    return (
        <div className={`flex gap-8 p-16 min-h-[calc(100vh-4rem)] items-stretch justify-center ${
            isDark ? "bg-black" : "bg-gray-100"
        }`}>
            {/* 왼쪽 */}
            <div className="flex flex-col gap-12 w-80 shrink-0">
                <StorageChart />
                <SummaryPanel />
            </div>

            {/* 가운데 */}
            <div className="flex flex-col gap-12 w-96 shrink-0">
                <ErrorMonitor />
                <ConsoleErrorPanel />
            </div>

            {/* 오른쪽 */}
            <div className="flex flex-col gap-12 w-[420px] shrink-0">
